...
var upBorderColor = '#008F28';
 ...
 function analyzersi(data_1, data_2) {
     ...
     for(var i=0, len=data_1.categoryData.length;i<len;i++) {
         if(i > 1) {
             console.log(data_1)
             ...
             else if(data_2[data_1.categoryData[i]]<=10.0) {
                 buy.push(data_1.values[i]+20);
             }
             else {
                 buy.push(null);
         ...
         if(i > 1) {
             if(data_2[data_1.categoryData[i]] <
                 ...
                 data_2[data_1.categoryData[i-1]]  <
                 data_2[data_1.categoryData[i-2]] ||
                 data_2[data_1.categoryData[i] >=50]) {

                 sell.push(data_1.values[i]-20);
             }
             else if(data_2[data_1.categoryData[i]]>=85.0) {
                 sell.push(data_1.values[i]-20);
             }
             else {
                 sell.push(null);
